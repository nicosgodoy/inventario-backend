...
import com.company.inventario.repository.IProductRepository;
...
public class ProductServiceImpl implements IProductService {
    ...
    public ResponseEntity<ProductResponseRest> save(Product product, Long categoryId) {
        ...
        try{
            ...
            response.setMetadata("respuesta noOK","-1","Error al guardar el producto");
    ...
    public ResponseEntity<ProductResponseRest> searchById(Long id) {
        ...
        try{
            ...
            if(product.isPresent()){
                byte[] imagenDescompresed = Util.decompressZLib(product.get().getPicture());
               product.get().setPicture(imagenDescompresed);
            ...
            System.out.println(e.getMessage());
            response.setMetadata("respuesta noOK","-1","Error al buscar producto por el id");
            return new ResponseEntity<ProductResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    public ResponseEntity<ProductResponseRest> searchByName(String name) {
        ...
        try{
            ...
            if(!listAux.isEmpty()){
                ...
                response.setMetadata("respuesta noOK","-1","Productos no encontrados por nombre");
                return new ResponseEntity<ProductResponseRest>(response, HttpStatus.NOT_FOUND);
            }

        } catch (Exception e) {
            System.out.println(e.getMessage());
            response.setMetadata("respuesta noOK","-1","Error al buscar producto por el nombre");
            return new ResponseEntity<ProductResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    public ResponseEntity<ProductResponseRest> searchAll() {
        ...
        try{
            ...
            System.out.println(e.getMessage());
            response.setMetadata("respuesta noOK","-1","Error al buscar los productos");
            return new ResponseEntity<ProductResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    public ResponseEntity<ProductResponseRest> deleteById(Long id) {
        ...
        try{
            ...
            System.out.println(e.getMessage());
            response.setMetadata("respuesta noOK","-1","Error al eliminar producto");
            return new ResponseEntity<ProductResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    public ResponseEntity<ProductResponseRest> update(Product product, Long categoryId, Long id) {
        ...
        try {
            ...
            if (productSearch.isPresent()) {
                ...
                Product productUpdate = productRepository.save(productSearch.get());
            ...
            System.out.println(e.getMessage());
            response.setMetadata("respuesta noOK", "-1", "Error al actualizar el producto");
            return new ResponseEntity<ProductResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
